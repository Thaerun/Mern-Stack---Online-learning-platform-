...
const ForgotPassword = () => {
    ...
    const handleOtpClick = async () => {
        try {
            await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/forgot-password`, { email });
    ...
    const handleUpdatePassword = async () => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/update-password`, { email, newPassword });
